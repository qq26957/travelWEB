...
export default {
  ...
  data() {
    return {
      ...
      hotList: [
        {
          imgUrl: `${imgBaseUrl}leshandafo.jpg`,
          name: "乐山大佛",
          english: "Buddha",
          id: 1
        },
        {
          imgUrl: `${imgBaseUrl}jiuzhaigou.jpg`,
          name: "九寨沟",
          english: "Jiuzhaigou",
          id: 2
        },
        {
          imgUrl: `${imgBaseUrl}hailuogou.jpg`,
          name: "海螺沟",
          english: "Conch'sditch",
          id: 3
        },
        {
          imgUrl: `${imgBaseUrl}yulongxueshan.jpg`,
          name: "玉龙雪山",
          english: "Snow Moutain",
          id: 4
        },
        {
          imgUrl: `${imgBaseUrl}daligucheng.jpg`,
          name: "大理古城",
          english: "Dali",
          lid: 5
        },
        {
          imgUrl: `${imgBaseUrl}erhai.jpg`,
          name: "洱海",
          english: "Erhai Laki",
          id: 6
        }
      ...
      recommendedList: [
        ...
        {
          imgUrl: `${imgBaseUrl}fushishan.jpg`,
          name: "富士山",
          english: "Mount Fuji",
          flag: false,
          id: 4
